                ...
                <div className="flex justify-center items-center w-screen h-screen">
                    ...
                    <div className="bg-white z-10 relative p-5 rounded-xl">
                        ...
                        <form onSubmit={(event) => addQuestionHandle(event)} >
                            {
                                answer ?
                                <input type="text" value={answerField} onChange={(e) => setAnswerField(e.target.value)} className="w-[300px] border py-2 px-3 rounded-lg block mb-5" placeholder="Answer" />
                                        :
